...
import (
	...
	spotify "github.com/nawafilhusnul/music-catalog/internal/models/spotify"
...
func (m *Mockservice) Search(ctx context.Context, query string, pageSize, pageIndex int) (*spotify.Tracks, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Search", ctx, query, pageSize, pageIndex)
	ret0, _ := ret[0].(*spotify.Tracks)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
